...
### 📅 Day 27  – Java Collections - GENERICS
*(Date: 17-Jan-2026)*

- Learned about Java Generics
- Parameterized Types
- Type Safety
- How Generics are implemented in Program 
🔗*Code Link* <br> 
👉 [Day 27 - Generics](https://github.com/KartikChourey/BridgeLabz-Training/tree/java-collections-practice/java-collections-practice/gcr-codebase/JavaCollectionsPractice/src/com/generics)
